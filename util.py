...
# print(srd_sru([[0, 0, 100, 1], [50, 0, 100, 1], [75, 25, 100, 1], [25, 100, 100, 1], [-25, 25, 100, 1]], 400, 1000, 600, 1500)) # seta
# print(srd_sru([[0, 0, 1, 1], [100, 0, 1, 1], [50, 50, 1, 1], [100, 100, 1, 1], [0, 100, 1, 1], [-75, 50, 1, 1]], 400, 1000, 600, 1500)) # bandeira
print(srd_sru([[0, 0, 1, 1], [25, 25, 1, 1], [25, 50, 1, 1], [50, 50, 1, 1], [25, 75, 1, 1], [0, 75, 1, 1], [0, 100, 1, 1], [-25, 75, 1, 1], [-25, 50, 1, 1], [-50, 50, 1, 1], [-25, 25, 1, 1], [0, 25, 1, 1]], 400, 1000, 600, 1500)) # cata_vento
